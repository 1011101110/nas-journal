...
summary: "Mobility plus dysregulation. The emergence of tantrums and the start of behavioral work."
order: 3
---

## Early Toddler (12 – 18 months)

**What defines this stage:** The child is now mobile and increasingly autonomous. This is when NAS behavioral challenges become most visible — and when early behavioral interventions should start.
...
**PCIT assessment:** 12–18 months is the earliest PCIT typically becomes appropriate (most protocols start at 18 months). If you're not yet connected with a PCIT-trained therapist, get on the waitlist now. ([PCIT](/interventions/pcit))
...
This is typically the hardest stage. The child requires constant supervision, has limited language to communicate needs, and melts down frequently. Sleep is still often disrupted. You're managing your own stress response while trying to co-regulate a child whose nervous system needs constant support.

This is when caregiver burnout begins. Name it. Get support. Co-regulation ([Co-Regulation](/interventions/co-regulation)) requires a regulated caregiver — and that means taking your own nervous system state seriously.

---

### What Comes Next

Language development in the next 6 months will change the picture significantly. Many behaviors driven by frustration at limited communication ease when the child can express themselves. Many don't — the regulation issues are deeper than communication.

→ [Toddler Stage](/age/toddler)
